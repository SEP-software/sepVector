...
namespace SEP
{
     ...
     void init_byteT(py::module &clsVector)
     {
          ...
          py::class_<byteTensor1D, byteHyper, std::shared_ptr<byteTensor1D> >(
              ...
              .def_buffer([](byteTensor1D &m) -> py::buffer_info {
                   return py::buffer_info(m.getVals(), sizeof(unsigned char),
                                          ...
                                          {m.getHyper()->getAxis(1).n}, {sizeof(unsigned char)});
              });
          py::class_<byteTensor2D, byteHyper, std::shared_ptr<byteTensor2D> >(
              ...
              .def_buffer([](byteTensor2D &m) -> py::buffer_info {
                   return py::buffer_info(
                       m.getVals(), sizeof(unsigned char), py::format_descriptor<unsigned char>::format(),
                       2, {m.getHyper()->getAxis(2).n, m.getHyper()->getAxis(1).n},
                       {sizeof(unsigned char) * m.getHyper()->getAxis(1).n, sizeof(unsigned char)});
              });

          py::class_<byteTensor3D, byteHyper, std::shared_ptr<byteTensor3D> >(
          ...
          py::class_<byteTensor4D, byteHyper, std::shared_ptr<byteTensor4D> >(
          ...
          py::class_<byteTensor5D, byteHyper, std::shared_ptr<byteTensor5D> >(
          ...
          py::class_<byteTensor6D, byteHyper, std::shared_ptr<byteTensor6D> >(
          ...
          py::class_<byteTensor7D, byteHyper, std::shared_ptr<byteTensor7D> >(
