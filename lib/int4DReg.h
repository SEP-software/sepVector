...
namespace SEP {
/*!
A regular sampled 4-D function with integer storage
*/
class int4DReg : public intHyper {
 public:
  /*!
 Create a 4-D integer vector from a hypercube
 \param hyper Hypercube describing RSF
 */
  int4DReg(std::shared_ptr<SEP::hypercube> hyper) { initNoData(hyper); }
  /*!
Create a 4-D integer vector from just lengths
...
*/
  ...
  /*!
   Create a 4-D integer vector from axes
...
*/
  ...
  */
  ...
  /*!
 Create a -D integer vector from axes
      \param a1,a2,a3,a4 Axes if the hypercube
      \param vals Vaules for the vector
 */
  int4DReg(const SEP::axis &a1, const SEP::axis &a2, const SEP::axis &a3,
 ...
 */
  ...
  std::shared_ptr<int4D> _mat;  ///< Storage for vector
...
*/
  void initData(std::shared_ptr<SEP::hypercube> hyper, const int4D &vals);
};
}  // namespace SEP
#endif
