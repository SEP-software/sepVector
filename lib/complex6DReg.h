...
namespace SEP {
/*!
A regular sampled 6-D function with complex float storage
*/
class complex6DReg : public complexHyper {
 public:
  /*!
   Create a 6-D complex float vector from a hypercube
...
*/
  ...
  std::shared_ptr<complex6D> _mat;  ///< Storage for vector
...
*/
  void initData(std::shared_ptr<SEP::hypercube> hyper, const complex6D &vals);
};
}  // namespace SEP
#endif
