...
namespace SEP
{
    ...
    */
    class intTensor7D : public floatHyper
    {
    public:
        /*!
      ...
      */
       ...
       */
        intTensor7D(const std::shared_ptr<SEP::hypercube> hyper, const float *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
    ...
    */
    class intTensor6D : public floatHyper
    {
    public:
        /*!
      ...
      */
       ...
       */
        intTensor6D(const std::shared_ptr<SEP::hypercube> hyper, const float *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
    ...
    */
    class intTensor5D : public floatHyper
    {
    public:
        /*!
      ...
      */
       ...
       */
        intTensor5D(const std::shared_ptr<SEP::hypercube> hyper, const float *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
    ...
    */
    class intTensor4D : public floatHyper
    {
    public:
        /*!
      ...
      */
       ...
       */
        intTensor4D(const std::shared_ptr<SEP::hypercube> hyper, const float *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
      ...
      */
        intTensor4D(const int n1, const int n2, const int n3, const int n4, const float *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1, n2, n3, n4};
            for (int n : ns)
    ...
    */
    class intTensor3D : public floatHyper
    {
    public:
        /*!
      ...
      */
       ...
       */
        intTensor3D(const std::shared_ptr<SEP::hypercube> hyper, const float *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
      ...
      */
        intTensor3D(const int n1, const int n2, const int n3, const float *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1, n2, n3};
            for (int n : ns)
    ...
    */
    class intTensor2D : public floatHyper
    {
    public:
        /*!
      ...
      */
       ...
       */
        intTensor2D(const std::shared_ptr<SEP::hypercube> hyper, const float *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
      ...
      */
        intTensor2D(const int n1, const int n2, const float *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1, n2};
            for (int n : ns)
    ...
    */
    class intTensor1D : public floatHyper
    {
    public:
        /*!
      ...
      */
       ...
       */
        intTensor1D(const std::shared_ptr<SEP::hypercube> hyper, const float *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
      ...
      */
        intTensor1D(const int n1, const float *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1};
            for (int n : ns)
