#ifndef short_tensor_h
#define short_tensor_h 1
...
/*!
  A regular sampled function that stores short values
*/
namespace SEP
{
    /*!
    A regular sampled 7-D function with short storage
    */
    class shortTensor7D : public shortHyper
    {
    public:
        /*!
         Create a 7-D short vector from a hypercube
        ...
        /*!
       Create a 7-D short vector from just lengths
       ...
       */
        ...
        /*!
      Create a 7-D short vector from axes
      ...
      */
       ...
       */
        shortTensor7D(const std::shared_ptr<SEP::hypercube> hyper, const short *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
      ...
      */
        shortTensor7D(const int n1, const int n2, const int n3, const int n4,
                      const int n5, const int n6, const int n7, const short *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1, n2, n3, n4, n5, n6, n7};
            for (int n : ns)
       ...
       */
        ...
        void allocate()
        {
            ...
            xt::xtensor<short, 7>::shape_type shape = {(size_t)ns[6], (size_t)ns[5], (size_t)ns[4],
      ...
      */
       ...
       */
        ...
        xt::xtensor<short, 7> mat; ///< Storage for vector
    ...
    protected:
      ...
      */
        void initData(std::shared_ptr<SEP::hypercube> hyper, const short *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
    ...
    /*!
    A regular sampled 6-D function with short storage
    */
    class shortTensor6D : public shortHyper
    {
    public:
        /*!
         Create a 6-D short vector from a hypercube
              \param hyper Hypercube describing RSF
        ...
        /*!
       Create a 6-D short vector from just lengths
       ...
       */
        ...
        /*!
      Create a 6-D short vector from axes
      ...
      */
       ...
       */
        shortTensor6D(const std::shared_ptr<SEP::hypercube> hyper, const short *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
      ...
      */
        shortTensor6D(const int n1, const int n2, const int n3, const int n4,
                      const int n5, const int n6, const short *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1, n2, n3, n4, n5, n6};
            for (int n : ns)
       ...
       */
        ...
        {
            std::vector<int> ns = getHyper()->getNs();
            xt::xtensor<short, 6>::shape_type shape = {(size_t)ns[5], (size_t)ns[4],
                                                       (size_t)ns[3], (size_t)ns[2], (size_t)ns[1], (size_t)ns[0]};
      ...
      */
       ...
       */
        ...
        xt::xtensor<short, 6> mat; ///< Storage for vector
    ...
    /*!
    A regular sampled 5-D function with short storage
    */
    class shortTensor5D : public shortHyper
    {
    public:
        /*!
         Create a 5-D short vector from a hypercube
              \param hyper Hypercube describing RSF
      ...
      */
       ...
       */
        shortTensor5D(const std::shared_ptr<SEP::hypercube> hyper, const short *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
        /*!
      Create a 5-D short vector from just lengths
          \param n1,n2,n3,n4,n5 Dimensions of the hypercube
          \param vals Values to fill vector with

      */
        shortTensor5D(const int n1, const int n2, const int n3, const int n4,
                      const int n5, const short *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1, n2, n3, n4, n5};
            for (int n : ns)
        ...
        /*!
       Create a 5-D short vector from axes
       ...
       */
        ...
        {
            std::vector<int> ns = getHyper()->getNs();
            xt::xtensor<short, 5>::shape_type shape = {(size_t)ns[4],
                                                       (size_t)ns[3], (size_t)ns[2], (size_t)ns[1], (size_t)ns[0]};
      ...
      */
       ...
       */
        ...
        xt::xtensor<short, 5> mat; ///< Storage for vector
    ...
    /*!
    A regular sampled 4-D function with short storage
    */
    class shortTensor4D : public shortHyper
    {
    public:
        /*!
         Create a 4-D short vector from a hypercube
              \param hyper Hypercube describing RSF
        ...
        /*!
       Create a 4-D short vector from just lengths
       ...
       */
        ...
        /*!
      Create a 4-D short vector from axes
      ...
      */
       ...
       */
        shortTensor4D(const std::shared_ptr<SEP::hypercube> hyper, const short *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
      ...
      */
        shortTensor4D(const int n1, const int n2, const int n3, const int n4, const short *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1, n2, n3, n4};
            for (int n : ns)
      ...
      */
       ...
       */
        ...
        xt::xtensor<short, 4> mat; ///< Storage for vector
    ...
    /*!
    A regular sampled 3-D function with short storage
    */
    class shortTensor3D : public shortHyper
    {
    public:
        /*!
         Create a 3-D short vector from a hypercube
              \param hyper Hypercube describing RSF
        ...
        /*!
       Create a 3-D short vector from just lengths
       ...
       */
        ...
        /*!
      Create a 3-D short vector from axes
      ...
      */
       ...
       */
        shortTensor3D(const std::shared_ptr<SEP::hypercube> hyper, const short *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
      ...
      */
        shortTensor3D(const int n1, const int n2, const int n3, const short *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1, n2, n3};
            for (int n : ns)
      ...
      */
       ...
       */
        ...
        xt::xtensor<short, 3> mat; ///< Storage for vector
    ...
    /*!
    A regular sampled 2-D function with short storage
    */
    class shortTensor2D : public shortHyper
    {
    public:
        /*!
         Create a 2-D short vector from a hypercube
              \param hyper Hypercube describing RSF
        ...
        /*!
          Create a 2-D short vector from a 7-D short
        ...
        /*!
          Create a 2-D short vector from a 6-D short
        ...
        /*!
          Create a 2-D short vector from a 5-D short
        ...
        /*!
          Create a 2-D short vector from a 4-D short
        ...
        /*!
          Create a 2-D short vector from a 3-D short
        ...
        /*!
          Create a 2-D short vector from a 2-D short
        ...
        /*!
       Create a 2-D short vector from just lengths
       ...
       */
        ...
        /*!
      Create a 2-D short vector from axes
      ...
      */
       ...
       */
        shortTensor2D(const std::shared_ptr<SEP::hypercube> hyper, const short *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
      ...
      */
        shortTensor2D(const int n1, const int n2, const short *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1, n2};
            for (int n : ns)
       ...
       */
        ...
        {
            std::vector<int> ns = getHyper()->getNs();
            xt::xtensor<short, 2>::shape_type shape = {
      ...
      */
       ...
       */
        ...
        xt::xtensor<short, 2> mat; ///< Storage for vector
    ...
    */
    class shortTensor1D : public shortHyper
    {
    public:
        /*!
      ...
      */
       ...
       */
        shortTensor1D(const std::shared_ptr<SEP::hypercube> hyper, const short *vals)
        {
            initNoData(hyper);
            copyVals(vals);
        }
        ...
        /*!
          Create a 1-D short vector from a 2-D short
        ...
        /*!
          Create a 1-D short vector from a 3-D short
        ...
        shortTensor1D(const std::shared_ptr<shortTensor3D> old, const int iax1,
                      ...
                      const std::vector<int> &end);
        /*!
          Create a 1-D short vector from a 4-D short
        ...
        shortTensor1D(const std::shared_ptr<shortTensor4D> old, const int iax1,
                      ...
                      const std::vector<int> &end);
        /*!
          Create a 1-D short vector from a 1-D short
        ...
        shortTensor1D(const std::shared_ptr<shortTensor1D> old, const int iax1,
                      ...
                      const std::vector<int> &end);
        /*!
          Create a 1-D short vector from a 5-D short
        ...
        shortTensor1D(const std::shared_ptr<shortTensor5D> old, const int iax1,
                      ...
                      const std::vector<int> &end);
        /*!
          Create a 1-D short vector from a 6-D short
        ...
        shortTensor1D(const std::shared_ptr<shortTensor6D> old, const int iax1,
                      ...
                      const std::vector<int> &end);
        /*!
          Create a 1-D short vector from a 7-D short
      ...
      */
        shortTensor1D(const int n1, const short *vals)
        {
            std::vector<SEP::axis> a;
            std::vector<int> ns = {n1};
            for (int n : ns)
      ...
      */
       ...
       */
        ...
        xt::xtensor<short, 1> mat; ///< Storage for vector
